...
namespace WebSiteBanHang.Models
{
    ...
    public partial class QuanLyBanHangEntities : DbContext
    {
        ...
        public virtual ObjectResult<DSSanPham_DT_Result> DSSanPham_DT()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<DSSanPham_DT_Result>("DSSanPham_DT");
        }
    
        public virtual ObjectResult<spDienThoai_Result> spDienThoai(Nullable<int> loaisp)
        {
            var loaispParameter = loaisp.HasValue ?
                new ObjectParameter("loaisp", loaisp) :
                new ObjectParameter("loaisp", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spDienThoai_Result>("spDienThoai", loaispParameter);
        }
    }
}
